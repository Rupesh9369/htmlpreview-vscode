...
- 💻 **Interactive Selection Sandbox**: Select any HTML text in your editor, right-click, and choose **HTML Preview** to open a live split-pane sandbox (similar to JSFiddle/CodePen) with dedicated HTML, CSS, and JS inputs.
- ⚓ **VS Code Status Bar Launcher**: A dynamic launcher button (`⚡ HTML Preview`) appears automatically at the bottom of VS Code whenever you open supported files.
...
4. Click the **`⚡ HTML Preview`** button in the bottom status bar (or right-click and select **HTML Preview**).
